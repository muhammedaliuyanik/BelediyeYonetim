...
namespace BelediyeYonetim
{
    public partial class Form4 : Form
    {
        ...
        OleDbConnection baglanti = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=belediye.mdb"); // BAGLANTI SAGLAMA
        ...
        private void button2_Click_1(object sender, EventArgs e) // KAYDET BUTONU
        {
            ...
            baglanti.Close();
            MessageBox.Show("Vatandaş kaydı eklenme işlemi başarılı !", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            textBox1.Clear();
            textBox2.Clear();
            textBox3.Clear();
            textBox4.Clear();
